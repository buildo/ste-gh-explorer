...
const HelloName = queries(({ randomName }: { randomName?: string }) => (
  !randomName ? <View>...</View> : <FormattedMessage id='Hello.hello' values={{ name: randomName }} />
)) as any as React.ComponentType<{ length: number }>;
